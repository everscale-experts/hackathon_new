...
const CONTRACT = 'KT1WGc5s9WwGHi5TUGAGvX9dSP1sbD8qdEc6';// адресс опублекованного контракта 
...
export class token_transfer {
    ...
    public async transfer(contract1: string,) {
        ...
        'KT1X7iHDQB6iQvejCkwVqE2Nk78fdrcbw66s',// аресс контракта токенов
        '3',                                   // id токена
        '10000000000',                         // количество в найменьших единицах токена 
        'tz1LpyieamcZRUAEqXxRz6k7yEG1GfMkX3At',// кому переводиться токены
