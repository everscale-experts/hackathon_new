    ...
    public async transfer(contract1: string) {
        ...
        const batch = await this.tezos.wallet.batch()
            ...
            .withContractCall(
                contract.methods
                    .default(
                        "tz1Nt3vKhbZpVdCrqgxR9sZDFqUty2h7SMRM",            // addressReсeiverTz
                        "tz1VcUcuUEcUGSZRcxNcj8JCrCG1xhZVRYt6",                 // addressSenderTz
                        "2000",                                                 // amoutTz
                        "0:c54a25311764a560d64b70b8c334991462e56da9bd48df0074c3b0ed27f4f4fd", // addressReсeiverEver
                        "KT1KR2ft6aRthjkcvTW9FrEPRQoxrfuTpark",                 // addressContractToken
                        "2"                                                     // id транзакции
                    ),
            );
        ...
        return batchOp.confirmation(1)
            .then(() => batchOp.opHash)                                               // ждем одно подтверждение сети
