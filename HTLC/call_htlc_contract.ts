...
async function example() {
    ...
    try {
      ...
      batch
      .withContractCall(contract.methods.openLock('KT1JMWkKAtB8eNMTYSAmkRuS3xjKHdkgTVGW', char2Bytes('a')))
      
      // .withContractCall(contract.methods.createLock(sha256(char2Bytes('a')),'KT1JMWkKAtB8eNMTYSAmkRuS3xjKHdkgTVGW' ));
